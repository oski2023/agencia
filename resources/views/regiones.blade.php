            ...
            <tr>
                ...
                <th  class="py-1 px-3 text-right w1/6">
                    <a href="/region/create"
                       class="inline-flex items-center py-1 px-4 border-2 rounded-md border-green-400 dark:border-green-600 text-sm font-medium leading-5 text-gray-900 dark:text-green-400 hover:bg-green-900 focus:outline-none focus:border-green-700 transition duration-150 ease-in-out"
                    >  agregar  </a>
                </th>
            </tr>
            </thead>
